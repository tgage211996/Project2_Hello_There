...
public class PostRepo {
  ...
  /**
   * This method is used to get a particular user
   * @param username
   * @return
   */
  ...
  /**
   * This method is used to update a user's post
   * @param id
   * @param content
   */
    @Transactional (propagation = Propagation.REQUIRES_NEW, isolation = Isolation.SERIALIZABLE)
  ...
  /**
   * This method is used to flag a users post a inappropriate
   * @param id id of the post in question
   */
  @Transactional (propagation = Propagation.REQUIRES_NEW, isolation = Isolation.SERIALIZABLE)
